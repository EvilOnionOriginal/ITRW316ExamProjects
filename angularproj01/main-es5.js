...
var ListItemComponent = /** @class */ (function () {
    function ListItemComponent(listService) {
    ...
    // set dynamic classes
    ListItemComponent.prototype.setClasses = function (list) {
        var classes = {
            list: true
        };
        return classes;
    };
    ListItemComponent.prototype.onToggle = function (list) {
        list.id = list.id - 1;
        if (list.id > 1) {
            this.deleteList.emit(list);
        }
    };
    ListItemComponent.prototype.onDelete = function (list) {
        this.deleteList.emit(list);
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
var ListsComponent = /** @class */ (function () {
    ...
    ListsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.listService.getLists().subscribe(function (lists) { _this.lists = lists; });
    };
    ListsComponent.prototype.deleteList = function (list) {
        // this.deleteList(list:List) {
        // Remove From UI
        this.lists = this.lists.filter(function (t) { return t.id !== list.id; });
        // Remove from server
        this.listService.deleteList(list).subscribe();
    };
    ListsComponent.prototype.addList = function (list) {
        var _this = this;
        this.listService.addList(list).subscribe(function (list) {
...
var ListService = /** @class */ (function () {
    ...
    // Toggle Completed
    ListService.prototype.toggleCompleted = function (list) {
        var url = this.listsURL + "/" + list.id;
